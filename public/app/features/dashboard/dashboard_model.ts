...
export class DashboardModel {
  ...
  repeatPanel(panel: PanelModel, panelIndex: number) {
    ...
    let selectedOptions;
    if (panel.scopedVars !== undefined && panel.scopedVars[variable.name] !== undefined) {
      selectedOptions = panel.scopedVars[variable.name];
    } else {
      selectedOptions = this.getSelectedVariableOptions(variable);
    }
